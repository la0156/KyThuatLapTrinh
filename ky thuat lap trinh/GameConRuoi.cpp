...
#include "../ky thuat lap trinh/library/loadpng.h"
#include "../ky thuat lap trinh/library/process_image.h"
#include "../ky thuat lap trinh/library/gl_texture.h"
...
int main(int argc, char**argv)
{
	...
	int POX_X = (glutGet(GLUT_SCREEN_WIDTH) - WIDTH) >> 1;
	int POX_Y = (glutGet(GLUT_SCREEN_HEIGHT) - HEIGHT) >> 1;
	glutInitWindowPosition(POX_X, POX_Y);
	glutInitWindowSize(WIDTH, HEIGHT);
	glutCreateWindow("Catch Files");
